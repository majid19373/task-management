...
use App\ValueObjects\Board\{Src\domain\Entities\Board\ValueObjects\BoardName};
...
final readonly class BoardRepository implements BoardRepositoryInterface
{
    ...
    public function existsByUserIdAndName(int $userId, \Src\domain\Entities\Board\ValueObjects\BoardName $name): bool
    {
        $qb = $this->em->createQueryBuilder();
